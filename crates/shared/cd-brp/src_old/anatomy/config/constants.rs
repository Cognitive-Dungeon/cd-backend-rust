...
/// Множитель влияния гиповолемического шока на потерю сознания.
/// При 2.0 потеря 50% крови приведет к 100% штрафу (обморок).
pub const SHOCK_CONSCIOUSNESS_MULTIPLIER: f32 = 2.0;
